...
from .views import PostDetailWithSlugFromParams, PostListDetailFilter,PostDetailWithSlug, PostSearchBlogger, PostList, PostListAllPublished, PostListForBlogger, PostDetailWithId, PostDetailWithId2 #, PostDetailWithSlug,  # was used for generic views
...
urlpatterns = [
    ...
    path('posts/', PostDetailWithSlugFromParams.as_view(), name='detailcreate'), # http://127.0.0.1:8000/api/posts/?slug=dogan-blog-2-selamlar-dogut, this view get the param from request url, thats why we don't have any parameters after "posts/"
